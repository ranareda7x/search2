    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                <form action="handlers/Insert_task.php" method="POST" class="form border p-2 my-5">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="handlers/delete-task.php?id=<?php echo $row['id']; ?>" class="btn btn-info"><i class="fa-solid fa-edit"></i> </a>
                                </td>
                            </tr>
                              <?php endwhile; ?>
